// =========================================================
// mobile-audit.js —— 移动端体验回归审计（tabbit 任务脚本）
// 用法见 tools/TESTING.md；通过标准：
//   0 横向溢出 / 无控制台报错 / 核心触控≥40px / input字号≥16px(≤640) / 导航≥11px
// =========================================================
(async () => {
  const BASE = "https://study-hard-racate.github.io/byj.github.io/"; // 可改为本地 http://127.0.0.1:8765/byj.github.io/
